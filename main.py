...
while safe == False:
    ...
    p1 = chooseSign(1)
    print("Player 1's sign is {}".format(p1))
    p2 = chooseSign(2)
    print("Player 2's sign is {}".format(p2))
...
def check():
    ...
    if board[0][0] == board[1][1] == board[2][2]:
        print("Player 1 wins!") if board[0][0] == p1 else print("Player 2 wins!")
        running = False
        return
    
    if board[0][2] == board[1][1] == board[2][0]:
        print("Player 1 wins!") if board[0][2] == p1 else print("Player 2 wins!")
        running = False
        return
